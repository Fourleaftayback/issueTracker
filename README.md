...
This page tracks issues created for a project. You can update the issues, close, and delete the issues. Also Prevents cross-site scripting (XSS) attacks.
...
[Issue Tracker](https://jade-volcano.glitch.me/)

This was built with Node, MongoDB, and Chai.